# Generated by Django 3.2.5 on 2021-08-21 21:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(related_name='file_actor', to='movies.Actor', verbose_name='актори')),
                ...
                ('directors', models.ManyToManyField(related_name='file_director', to='movies.Actor', verbose_name='режисер')),
